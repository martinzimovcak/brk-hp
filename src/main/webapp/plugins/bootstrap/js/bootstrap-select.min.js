      ...
      (e.prototype = {
            ...
            this.$element.find('option').each(function (b) {
              ...
              if ((h++, !c.hasClass('bs-title-option'))) {
                var g = this.className || '',
                  ...
                  o =
                    'undefined' != typeof c.data('icon') ? '<span class="' + d.options.iconBase + ' ' + c.data('icon') + '"></span> ' : '',
                ...
                if (
                  (c.data('content') || (l = o + '<span class="text">' + l + n + '</span>'),
                    ...
                    var q = this.parentElement.label,
                      r =
                        'undefined' != typeof c.parent().data('subtext')
                          ? '<small class="text-muted">' + c.parent().data('subtext') + '</small>'
                          : '',
                      s = c.parent().data('icon')
                        ? '<span class="' + d.options.iconBase + ' ' + c.parent().data('icon') + '"></span> '
                        : '',
              ...
              .map(function () {
                if (this.selected) {
                  if (
                    ...
                    (this.disabled || ('OPTGROUP' === this.parentElement.tagName && this.parentElement.disabled))
                  )
                    return !1;
                  var b,
                    c = a(this),
        ...
        selectPosition: function () {
          ...
          this.$newElement.on('click', function () {
            d.isDisabled() ||
              (g(a(this)), f.appendTo(d.options.container), f.toggleClass('open', !a(this).hasClass('open')), f.append(d.$menu));
          }),
        ...
        setDisabled: function (a, b, c) {
          if (!c) var c = this.findLis().eq(this.liObj[a]);
          b
            ? c.addClass('disabled').children('a').attr('href', '#').attr('tabindex', -1)
            : c.removeClass('disabled').children('a').removeAttr('href').attr('tabindex', 0);
        },
        isDisabled: function () {
            ...
            this.$menu.on('click', 'li a', function (c) {
              ...
              if ((b.multiple && c.stopPropagation(), c.preventDefault(), !b.isDisabled() && !d.parent().hasClass('disabled'))) {
                ...
                b.multiple ? b.options.liveSearch && b.$searchbox.focus() : b.$button.focus(),
                  ((f != b.$element.val() && b.multiple) || (g != b.$element.prop('selectedIndex') && !b.multiple)) &&
                    (b.$element.change(), b.$element.trigger('changed.bs.select', [e, i.prop('selected'), j]));
              }
            }),
            ...
            this.$searchbox.on('input propertychange', function () {
              if (d.$searchbox.val()) {
                ...
                (f = d.options.liveSearchNormalize
                  ? f.not(':a' + d._searchStyle() + '(' + b(d.$searchbox.val()) + ')')
                  : f.not(':' + d._searchStyle() + '(' + d.$searchbox.val() + ')')),
                ...
                g.each(function (b) {
                  var c = a(this);
                  c.hasClass('divider') &&
                    (c.index() === g.eq(0).index() || c.index() === g.last().index() || g.eq(b + 1).hasClass('divider')) &&
                    c.addClass('hidden');
                }),
        ...
        keydown: function (c) {
          ...
          if (
            ...
            !l &&
              ...
              (o.options.container ? o.$newElement.trigger('click') : (o.setSize(), o.$menu.parent().addClass('open'), (l = !0)),
              o.$searchbox.focus()),
              ...
              m.val() ||
                ...
                (0 === d.filter('.active').length &&
                  ...
                  (d = o.options.liveSearchNormalize
                    ? d.filter(':a' + o._searchStyle() + '(' + b(q[c.keyCode]) + ')')
                    : d.filter(':' + o._searchStyle() + '(' + q[c.keyCode] + ')'))))),
            d.length)
          ) {
            if (/(38|40)/.test(c.keyCode.toString(10)))
              (e = d.index(d.filter(':focus'))),
                ...
                38 == c.keyCode
                  ...
                  : 40 == c.keyCode &&
                    (o.options.liveSearch && (e += 1), -1 == e && (e = 0), e != j && f > e && (e = f), e > h && (e = h), e == k && (e = g)),
                m.data('prevIndex', e),
                o.options.liveSearch
                  ? (c.preventDefault(),
                    m.hasClass('dropdown-toggle') || (d.removeClass('active').eq(e).addClass('active').children('a').focus(), m.focus()))
                  : d.eq(e).focus();
            else if (!m.is('input')) {
              var r,
                s,
              ...
              d.each(function () {
                a(this).parent().hasClass('disabled') ||
                  (a.trim(a(this).text().toLowerCase()).substring(0, 1) == q[c.keyCode] && t.push(a(this).parent().index()));
              }),
                ...
                s != q[c.keyCode]
                  ...
                  : r >= t.length && (a(document).data('keycount', 0), r > t.length && (r = 1)),
                d.eq(t[r - 1]).focus();
            }
            ...
            ((/(^9$|27)/.test(c.keyCode.toString(10)) && l && (o.multiple || o.options.liveSearch)) ||
