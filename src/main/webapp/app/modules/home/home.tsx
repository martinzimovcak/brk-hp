    ...
    return (
      <>
        <div className="page-content bg-white home-slider-5">
          ...
          <SliderHome
            content={homeSliderContent5}
            contentWrapperClass="sliderStyle5"
            buttonClass="site-button"
            buttonText="O NÁS"
            button2Text="CO UMÍME"
            show2Button
          />
                  ...
                  <div className="col-lg-6 col-md-6 col-sm-12 col-12 wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.6s">
                    <div className="content-bx1">
                      <div className="about-year">
                        <span>13</span>
                        <p>Let<br/>Zkušeností</p>
                      </div>
                      <div className="section-head style2">
                        <h2 className="title">Architektura je umění,<br/> a stavby</h2>
                        <p>Štěpán doplní něco smysluplného vata = Praesent pharetra orci odio, ut mattis tellus ullamcorper ornare. Suspendisse ullamcorper metus in erat viverra, vehicula pharetra dolor accumsan. In arcu ex, rutrum finibus malesuada vel. Praesent pharetra orci odio, ut mattis tellus</p>
                      </div>
                      <Link to="/portfolio-details" className="site-button m-r10 m-b10 btnhover20">Zobrazit portfolio</Link>
                      <Link to="/about-1" className="site-button black m-b10 btnhover20">O nás</Link>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-6 col-md-6">
                    <div className="about-content wow fadeIn" data-wow-delay="0.2s"  data-wow-duration="2s">
                      <div className="section-head style2">
                        <h2 className="title">Náš poslední projekt<br/>Rekonstrukce obchodního centra Háje</h2>
                        <p>Zase Štěpán doplní vata = Praesent pharetra orci odio, ut mattis tellus ullamcorper ornare. Suspendisse ullamcorper metus in erat viverra, vehicula pharetra dolor accumsan. In arcu ex, rutrum finibus malesuada </p>
                      </div>
                      <div className="m-b30">
                      ...
                      <div className="">
                        <Link to="/portfolio-details" className="site-button btnhover20">Zobrazit Portfolio</Link>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="section-full bg-white content-inner-2 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s">
              <div className="container">
                <div className="section-head style2 text-center">
                  ...
                  <p>Štěpán doplní vata = Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                </div>
            ...
            <div className="section-full bg-white content-inner-1 project-area project-style-1  bg-img-fix" style={{"backgroundImage":"url(" + bg2 + ")","backgroundSize":"cover"}}>
              <div className="container">
                <div className="section-head text-white style2 wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.6s">
                  ...
                  <Link to="/contact-1" className="site-button btnhover20 m-r10 m-b10">Kontaktujte nás</Link>
                  <Link to="/portfolio-details" className="site-button btnhover20 m-b10">Zobrazit více</Link>
                </div>
                <ReferencesSlider2/>
              ...
              <div className="container">
                <div className="row">
                  <div className="col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s">
                    <div className="icon-bx-wraper sr-iconbox style2">
                      <div className="icon-lg m-b10">
                        <Link to="#" className="icon-cell"><i className="flaticon-worker"/></Link>
                      </div>
                  ...
                  <div className="col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.6s">
                    <div className="icon-bx-wraper sr-iconbox style2">
                      <div className="icon-lg m-b10">
                        <Link to="#" className="icon-cell"><i className="flaticon-factory-1"/></Link>
                      </div>
                      <div className="icon-content">
                  ...
                  <div className="col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.9s">
                    <div className="icon-bx-wraper sr-iconbox style2">
                      <div className="icon-lg m-b10">
                        <Link to="#" className="icon-cell"><i className="flaticon-design-tools"/></Link>
                      </div>
                      <div className="icon-content">
                  ...
                  <div className="col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s">
                    <div className="icon-bx-wraper sr-iconbox style2">
                      <div className="icon-lg m-b10">
                        <Link to="#" className="icon-cell"><i className="flaticon-settings"/></Link>
                      </div>
                      <div className="icon-content">
                  ...
                  <div className="col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.9s">
                    <div className="icon-bx-wraper sr-iconbox style2">
                      <div className="icon-lg m-b10">
                        <Link to="#" className="icon-cell"><i className="flaticon-factory-2"/></Link>
                      </div>
                      <div className="icon-content">
