...
import responsive from './slider-responsive'
...
const SliderBlog = (props) => {
        ...
        const imgEffect   = props.imgEffect || ""
        const blogPostCls = props.blogPostCls || "blog-grid blog-rounded blog-effect1 post-style-3"
                    ...
                    {props.data.map((item, id) => (
                        <div key={id} className="item">
                            <div className={`blog-post ${blogPostCls}`}>
                                <div className={`dlab-post-media dlab-img-effect ${imgEffect}`}> <Link to="#"><img src={item.image} alt="" /></Link> </div>
